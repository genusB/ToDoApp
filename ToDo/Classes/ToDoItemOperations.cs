...
namespace ToDo.Classes
{
    internal abstract class ToDoItemOperations
    {
        ...
        public void Add()
        {
            var itemWindow = new ToDoItemWindow(ProjectId);
        ...
        public void Selected()
        {
            ...
            var itemWindow = new ToDoItemWindow(ProjectId, item);
            ...
            if (itemWindow.ToDelete)
            {
                if (ItemService.Remove(item))
                    ToDoItemsCollection.Remove(item);
            ...
            if (IsCorrect(itemWindow.Item))
                ToDoItemsCollection[index] = itemWindow.Item;
            else
                ToDoItemsCollection.Remove(item);
        ...
        private void Timer_OnTick(object sender, EventArgs e)
        {
            ...
            ToDoItemsCollection.Remove(toDoItem);
        ...
        public void Checked(object sender)
        {
            ...
            var toDoItem = ToDoItemsCollection[_toDoItemsListView.Items.IndexOf(item)];
